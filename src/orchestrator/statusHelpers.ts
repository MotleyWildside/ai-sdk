import { StepResult, OkArgs, FailedArgs, RedirectArgs, BaseContext } from "./types";
 ...
 */
export function failed<C extends BaseContext>(args: FailedArgs<C>): StepResult<C> {
 ...
 */
export function redirect<C extends BaseContext>(args: RedirectArgs<C>): StepResult<C> {
